    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f9fafb' }}>
      <div style={{ width: 360 }}>
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          ...
          <div style={{ fontSize: 16, fontWeight: 600 }}>Africa Marketing Platform</div>
        ...
        <p style={{ textAlign: 'center', fontSize: 11, color: '#9ca3af', marginTop: 16 }}>Problème de connexion ? Contactez votre administrateur.</p>
      </div>
    </div>
  )
}
